...
(function(global, factory) {
    ...
    var clipAntimeridian = clip(
        ...
        clipAntimeridianInterpolate, [-pi$3, -halfPi$2]
    );
    ...
    function projectionMutator(projectAt) {
        ...
        projection.clipExtent = function(_) {
            return arguments.length ?
                ((postclip = _ == null ? ((x0 = y0 = x1 = y1 = null), identity$4) : clipRectangle((x0 = +_[0][0]), (y0 = +_[0][1]), (x1 = +_[1][0]), (y1 = +_[1][1]))), reset()) :
                x0 == null ?
                null : [
                    [x0, y0],
                    [x1, y1],
    ...
    function mercatorProjection(project) {
        ...
        m.clipExtent = function(_) {
            return arguments.length ?
                (_ == null ? (x0 = y0 = x1 = y1 = null) : ((x0 = +_[0][0]), (y0 = +_[0][1]), (x1 = +_[1][0]), (y1 = +_[1][1])), reclip()) :
                x0 == null ?
                null : [
                    [x0, y0],
                    [x1, y1],
